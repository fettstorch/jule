/**
 * Type-resolution probe. This file is never executed — it exists so
 * `tsc --noEmit` (moduleResolution: nodenext) proves the published
 * `.d.ts` surface resolves for a real consumer. If the package ships
 * broken types (e.g. extensionless re-exports under nodenext), this
 * fails to type-check.
 */
import {
  awaitable,
