...
/**
 * Packaging smoke test. Imports ONLY through the published package
 * name (never ../src), so it exercises the real exports map + built
 * dist. Proves the packed tarball is usable by a consumer.
 */
describe('@fettstorch/jule packaging', () => {
